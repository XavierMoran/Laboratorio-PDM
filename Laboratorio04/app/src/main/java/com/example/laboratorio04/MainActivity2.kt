...
class MainActivity2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //ui
        val editTextName = findViewById <TextView>(R.id.text_view_name);
        val editTextEmail = findViewById <TextView>(R.id.text_view_email);
        val editTextPhone = findViewById <TextView>(R.id.text_view_phone);
